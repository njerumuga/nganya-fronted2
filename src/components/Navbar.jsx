        ...
        >
            <div className="max-w-7xl mx-auto flex justify-between items-center px-4 md:px-6 py-4">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <Link to="/events" className={isActive("/events") ? active : linkBase}>
                        Events
                    </Link>

                    {isAdmin && (
                        <>
                            <Link to="/admin" className={isActive("/admin") ? active : linkBase}>
                                Admin
                            </Link>
                            <Link
                                to="/admin/nganya"
              ...
              bg-gradient-to-r from-purple-600 to-cyan-500 hover:brightness-110 transition"
                    ...
                    {isAdmin && (
                        <div className="pt-2 space-y-3">
                            ...
                            <Link
                                to="/admin/nganya"
                                className="block text-cyan-200 font-semibold"
                            >
                                Admin Nganyas
                            </Link>
                            <button
